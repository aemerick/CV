...
I study the formation and evolution of galaxies, from the smallest dwarf galaxies to massive galaxy clusters,
using hydrodynamics simulations run on high performance computers. For my thesis research, I developed a new model
for stellar feedback and galactic chemodynamics in the adaptive mesh refinement
hydrodynamics code \textsc{Enzo}. For the first time on galaxy-scales, we can simulate the
the feedback and chemical enrichment from individual star particles, including the effects
of stellar winds, supernovae, ionizing radiation followed with radiative transfer, and photoelectric heating.
This allows us to study the role of feedback in driving galaxy chemical evolution in unprecedented
detail. This research paves the way for the next generation of detailed, high-resolution galaxy-scale simulations.
Beyond my thesis work, I am also interested in gas stripping and quenching in low mass dwarf galaxies,
warm gas in galaxy clusters as probed through absorption, and developing new computing methods geared for petascale 
