...
\item[] Department of Astronomy, Columbia University - New York, NY\\
    ...
    Supervisors: Mordecai-Mark Mac Low, Ph.D and Jana Grcevich, Ph.D
		Supervisors (previous): Greg Bryan, Ph.D and Mary Putman, Ph.D
		\iflong
		\begin{innerlist}
		\item Research utilizes high resolution, large scale computational
		simulations to understand galaxy formation and evolution on all scales.
		\item Currently studying effects of the Milky Way's hot, gaseous halo
		on the evolution of its satellite dwarf galaxies, while including effects of  
		supernova feedback.
		\item Previously, produced synthetic Ly$\alpha$ absorption study of two
		simulated galaxy clusters to understand their warm gas content; used
		observations from the Hubble Space Telescope
		\item Utilize following code projects: \href{http://flash.uchicago.edu/site/}{FLASH},
		\href{http://enzo-project.org/}{Enzo}, \href{http://yt-project.org/}{\textit{yt}}
		\end{innerlist}
		\fi
\end{innerlist}
...
\vspace{-.1275in}
\begin{bibsection}
    \item \textbf{A. Emerick}, G. Bryan, M. E. Putman, "Warm Gas in and Around Simulated Galaxy Clusters as Probed by Absorption Lines", \textit{MNRAS} (2015) \textit{Accepted, pending revisions}
    
    \item \textbf{A. Emerick}, X. Zhao, R. Rapp, "Bottomonia in the Quark-Gluon Plasma and
	their Production at RHIC and LHC", \textit{Eur. Phys. J. A} (2012)
	\textbf{47}:72	
	
	\href{http://link.springer.com/article/10.1140%2Fepja%2Fi2012-12072-y}
	{doi: 10.1140/epja/i2012-12072-y}	
	
	\item S. Brown, \textbf{A. Emerick}, L. Rudnick, G. Brunetti, "Probing the Off-State of
	Cluster Radio Halos, 2011 \textit{ApJ} \textbf{740} L28 
	\href{http://dx.doi.org/10.1088/2041-8205/740/1/L28}{doi: 10.1088/2041-82505/740/1/L28}
\end{bibsection}
...
Graduate Awards
\begin{innerlist}
\item NSF Graduate Research Fellow \hfill Fall 2014, 3 yr\\
...
\begin{innerlist}
    \item C, C$++$, Fortran, Python, LaTex, R, UNIX shell scripting, 
    GNU make, LabVIEW
\end{innerlist}
